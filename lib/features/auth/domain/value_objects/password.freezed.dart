...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Password&&(identical(other.value, _this.value) || other.value == _this.value));
}
...
String toString() {
  final _this = this as Password;
  return 'Password(value: ${_this.value})';
}
